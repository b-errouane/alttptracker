(function(window) {
	...
	window.drawFullOverworldPanel = function(main)
	{
		...
		for(let [id,screen] of overworldScreens)
		{
			...
			if((mode === "editflutespots" || ((drawFluteSpots === "on" || (drawFluteSpots === "fluteshuffle" && fluteshuffle)) && ownItems.flute >= 1 && document.getElementById("activeflutebox").checked)) && darkWorld === (worldState === 'I') && (fluteshuffle ?customFluteSpots :vanillaFluteSpots).includes(id%0x40))
			...
			if((id === 0x18 || (id === 0x58 && mapMode === "single")) && mode === "editedges" && !fullOWConnectorStart && ownItems.flute >= 1 && !document.getElementById("activeflutebox").checked)
			...
			if(id%0x40 === 0x18 && (darkWorld === (worldState === 'I') || mapMode === "single") && mode === "editedges" && !fullOWConnectorStart && fluteshuffle && customFluteSpots.length != 8 && ownItems.flute >= 1 && document.getElementById("activeflutebox").checked)
