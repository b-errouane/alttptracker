(function(window) {
	...
	window.loadSpoiler = function(s)
	{
		...
		if(flags.mapmode != "N")
		{
			...
			window.setContent(64,dark,"Chest Game");
			window.setContent(65,light,"Bottle Merchant");
			window.setContent(66,light,"Sahasrahla");
			window.setContent(67,dark,"Stumpy");
			window.setContent(68,light,"Sick Kid");
			window.setContent(69,dark,"Purple Chest");
			window.setContent(70,light,"Hobo");
			window.setContent(71,mountain,"Ether Tablet");
			window.setContent(72,light,"Bombos Tablet");
			window.setContent(73,dark,"Catfish");
			window.setContent(74,light,"King Zora");
			window.setContent(75,mountain,"Old Man");
			window.setContent(76,light,"Potion Shop");
			window.setContent(77,light,"Lost Woods Hideout");
			window.setContent(78,light,"Lumberjack Tree");
			window.setContent(79,mountain,"Spectacle Rock Cave");
			window.setContent(80,light,"Cave 45");
			window.setContent(81,light,"Graveyard Ledge");
			window.setContent(82,light,"Checkerboard Cave");
			window.setContent(83,dark,"Hammer Pegs");
			window.setContent(84,light,"Library");
			window.setContent(85,light,"Mushroom");
			window.setContent(86,mountain,"Spectacle Rock");
			window.setContent(87,mountain,"Floating Island");
			window.setContent(88,light,"Maze Race");
			window.setContent(89,light,"Desert Ledge");
			window.setContent(90,light,"Lake Hylia Island");
			window.setContent(91,dark,"Bumper Cave");
			window.setContent(92,dark,"Pyramid");
			window.setContent(93,dark,"Digging Game");
			window.setContent(94,light,"Zora's Ledge");
			window.setContent(95,light,"Flute Spot");
			window.setContents(96,castle,["Sewers - Secret Room - Right","Sewers - Secret Room - Middle","Sewers - Secret Room - Left"]);
			window.setContents(97,castle,["Link's Uncle","Secret Passage"]);
			window.setContents(98,castle,["Hyrule Castle - Map Chest","Hyrule Castle - Boomerang Chest","Hyrule Castle - Zelda's Cell"]);
			window.setContent(99,castle,"Sanctuary");
			window.setContent(100,light,"Magic Bat");
			window.setContent(101,dark,"Blacksmith");
			window.setContents(102,dark,["Pyramid Fairy - Left","Pyramid Fairy - Right"]);
			window.setContent(103,light,"Master Sword Pedestal");
			window.setContent(104,castle,"Sewers - Dark Cross");
			window.setContents(105,light,["Waterfall Fairy - Left","Waterfall Fairy - Right"]);
			window.setContent(106,aga,"Castle Tower - Room 03");
			window.setContent(107,aga,"Castle Tower - Dark Maze");
		}
		spoilerLoaded = true;
	}
