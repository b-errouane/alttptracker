  ...
  window.logic_dungeon = {
    ...
    "Swamp Palace": {
      "Swamp Palace - Big Chest": {
        always: {
          allOf: ["canBreach|Swamp Palace", "keys|1", "bigkey", "flippers"],
          anyOf: [
            "canSpeckyClip",
            {
              allOf: [
        ...
        logical: {
          allOf: ["canReach|Swamp Palace", "hammer"],
        },
      },
      "Swamp Palace - Big Key Chest": {
        always: {
          allOf: ["canBreach|Swamp Palace", "flippers", "keys|1"],
          anyOf: ["canSpeckyClip", "hammer"],
        },
        logical: {
          allOf: ["canReach|Swamp Palace", "hammer"],
        },
      ...
      "Swamp Palace - Boss": {
        always: {
          allOf: ["canBreach|Swamp Palace", "flippers", "canKillBoss", "hookshot", "keys|1"],
          anyOf: ["canSpeckyClip", "hammer"],
        },
        logical: {
          allOf: ["canReach|Swamp Palace", "hammer"],
      ...
      "Swamp Palace - Flooded Room - Left": {
        always: {
          allOf: ["canBreach|Swamp Palace", "keys|1", "flippers", "hookshot"],
          anyOf: ["canSpeckyClip", "hammer"],
        },
        logical: {
          allOf: ["canReach|Swamp Palace", "keys|1", "hammer"],
        },
      },
    ...
    "Ice Palace": {
      "Ice Palace - Compass Chest": {
        always: {
          allOf: ["canBreach|Ice Palace", "canBurnThings", "canKillOrExplodeMostEnemies"],
        },
        logical: {
      ...
      "Ice Palace - Big Chest": {
        always: {
          allOf: ["canBreach|Ice Palace", "bigkey", "canBurnThings"],
          anyOf: [
            "bombs",
            {
      ...
      "Ice Palace - Map Chest": {
        always: {
          allOf: ["canBreach|Ice Palace", "canBurnThings", "glove", "hammer"],
          anyOf: [
            "canIceBreak",
            {
              allOf: [
