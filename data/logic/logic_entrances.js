(function(window) {
    ...
    "Agahnims Tower": {
        ...
        "Inverted": {
            "allOf": [
                "canReach|Inverted Hyrule Castle Balcony",
                "canOpenGT"
            ]
        }
    },
    ...
    "Bat Cave Drop": {
        "Open": {
            "anyOf": [
                ...
                {
                    "allOf": [
                        "hasFoundEntrance|Hammer Peg Cave",
                        "mirror"
                    ]
                }
            ]
    ...
    "Big Bomb Shop": {
        ...
        "Inverted": {
            "allOf": [
                "canReach|Inverted South Dark World"
            ]
        }
    },
    "Blacksmiths Hut": {
    ...
    "Bumper Cave (Top)": {
        ...
        "Inverted": {
            "allOf": [
                "hasFoundEntrance|Death Mountain Return Cave (West)",
                "mirror"
            ]
        }
    },
    ...
    "Dark Death Mountain Shop": {
        "Open": {
            "allOf": [
                "canReach|Lower East Dark Death Mountain"
            ]
        },
        "Inverted": {
            "allOf": [
                "canReach|Inverted Lower East Dark Death Mountain"
            ]
        }
    },
    "Dark Lake Hylia Ledge Fairy": {
        "Open": {
            "allOf": [
                "canReach|South East Dark World",
                "moonpearl",
                "bombs"
            ]
        },
        "Inverted": {
            "allOf": [
                "canReach|Inverted South East Dark World",
                "bombs"
            ]
        }
    },
    ...
    "Dark Potion Shop": {
        "Open": {
            "allOf": [
                "canReach|North East Dark World"
            ]
        },
        "Inverted": {
            "allOf": [
                "canReach|Inverted North East Dark World"
            ]
        }
    },
    "Dark Sanctuary Hint": {
    ...
    "East Dark World Hint": {
        "Open": {
            "allOf": [
                "canReach|East Dark World"
            ]
        },
        "Inverted": {
            "allOf": [
                "canReach|Inverted East Dark World"
            ]
        }
    },
    "Elder House (East)": {
    ...
    "Fairy Ascension Cave (Bottom)": {
        "Open": {
            "anyOf": [
                ...
                {
                    "allOf": [
                        "hasFoundEntrance|Turtle Rock Isolated Ledge Entrance",
                        "mirror"
                    ]
                },
                {
                    "allOf": [
                        "canReach|Lower East Death Mountain",
                        "mitts"
                    ]
                },
                {
    ...
    "Ganons Tower": {
        "Open": {
            "allOf": [
                "canReach|Upper Dark Death Mountain",
                "canOpenGT"
            ]
        },
        "Inverted": {
    ...
    "Mire Fairy": {
        ...
        "Inverted": {
            "allOf": [
                "canReach|Inverted South West Dark World"
            ]
        }
    },
    "Mire Hint": {
    ...
    "Skull Woods Final Section": {
        "Open": {
            "allOf": [
                "firerod",
                "moonpearl",
                "hasFoundEntrance|Skull Woods Second Section Door (West)"
            ]
        },
        "Inverted": {
            "allOf": [
    ...
    "Skull Woods Second Section Hole": {
        "Open": {
            ...
            "anyOf": [
                "hasFoundEntrance|Skull Woods Second Section Door (West)",
                "hasFoundEntrance|Skull Woods Final Section"
            ]
        },
        "Inverted": {
            "anyOf": [
    ...
    "Dark Death Mountain Fairy": {
        "Open": {
            "allOf": [
                "canReach|Lower West Dark Death Mountain"
            ]
        },
        "Inverted": {
            "allOf": [
    ...
    "Desert Palace Entrance (West)": {
        "Open": {
            "anyOf": [
                ...
                {
                    "allOf": [
                        "hasFoundEntrance|Desert Palace Entrance (North)",
                        "glove"
                    ]
                }
            ]
    ...
    "Old Man Cave (West)": {
        "Open": {
            "anyOf": [
                ...
                {
                    "allOf": [
                        "hasFoundEntrance|Bumper Cave (Bottom)",
                        "mirror"
                    ]
                }
            ]
